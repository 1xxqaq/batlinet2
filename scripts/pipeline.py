...
def main(config_path: str,
    ...
    if fixed_test_support_index_path is not None:
        configs['model']['fixed_test_support_index_path'] = \
            fixed_test_support_index_path
        ...
        if skip_evaluation_if_exists and model.workspace is not None and \
            ...
            if model.workspace is not None:
                obj = {
                    ...
                    'seed': seed,
                    'evaluation_protocol': {
                        'fixed_test_support_index_path': fixed_test_support_index_path,
